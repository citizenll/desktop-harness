/**
 * Browser client bundle for the Desktop-owned market plugin, mirroring the DeepSeek
 ...
 * exact `window.__ModuleLoader__.load({ id: "dsh-desktop-market"` prefix.
 */
