...
import evolutionRemote from '@deepseek-ai/dsh-host-evolution-control/remote'
...
} from '@deepseek-ai/dsh-host-evolution-control/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-evolution-control/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, evolutionRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
