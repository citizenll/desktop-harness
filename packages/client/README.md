...
| [`ui-settings-plugin-inventory/`](ui-settings-plugin-inventory/README.md) | Contributes the profile plugin center and managed source controls to Plugins settings. |
