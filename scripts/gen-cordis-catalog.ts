...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  skills: 'skills.md',
  sourceRepository: 'extensions.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  activeProfile: 'not a service: launcher-provided selected profile name — packages/boot/app-boot/README.md owns the profile boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ProfilePluginMutationReceipt: 'extensions.md',
  ProfilePluginsSnapshot: 'extensions.md',
  SourceRepositoryMutationReceipt: 'extensions.md',
  SourceRepositorySnapshot: 'extensions.md',
  SourceUpdateStrategy: 'extensions.md',
