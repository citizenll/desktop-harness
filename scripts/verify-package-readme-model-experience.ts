...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-plugin-inventory': { kind: 'none', reason: 'Browser-side source and profile control surface; registers nothing model-facing.' },
  ...
  'packages/host/evolution-control': { kind: 'none', reason: 'The privileged Remote gateway forwards explicit Client requests and registers nothing model-facing.' },
  ...
  'packages/extensions/profile-plugins': { kind: 'none', reason: 'The profile package-management seam registers nothing model-facing.' },
  'packages/extensions/profile-plugins-pnpm': { kind: 'none', reason: 'The pnpm provider changes profile dependencies only through explicit privileged requests and registers nothing model-facing.' },
  'packages/extensions/source-repository': { kind: 'none', reason: 'The managed source seam registers nothing model-facing.' },
  'packages/extensions/source-repository-git': { kind: 'none', reason: 'The Git provider changes the managed checkout only through explicit privileged requests and registers nothing model-facing.' },
